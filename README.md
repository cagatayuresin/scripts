...
| 04 | `ollama-lab` | Yerel Ollama: model envanteri, gerçek disk kullanımı (paylaşılan katmanları çözer), sağlık ve hız testleri | `make llm-list`, `make llm-disk`, `make llm-bench` | [docs](https://cagatayuresin.github.io/scripts/04_ollama-lab) |
